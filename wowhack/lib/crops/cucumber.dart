...
class CucumberPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CropOutlinePage(crop: 'Cucumber');
  }
}
            ...
            child: ListView(
              children: [
                ...
                SubheadingTile(title: 'Weed and Pest Management', content: [
                  'Weed and Pest Management: S-metolachlor, Napropamide, Glyphosate, Clethodim, Spinosad, Bifenthrin'
                ]),
                SubheadingTile(title: 'Shelf Life', content: [
                  'Shelf-life: 6 months'
                ]),
                SubheadingTile(title: 'Production', content: [
                  '2022-2023: 1832.2 Lakh Tonnes',
          ])
              ],
            ),
          ),
