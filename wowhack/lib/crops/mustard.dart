...
class MustardPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CropOutlinePage(crop: 'Mustard');
  }
}
          ...
          child: ListView(
            children: [
              ...
              SubheadingTile(title: 'Seeds', content: [
                ...
                'Seed Quantity: 4-5 kg/ha',
                'Germination Rate: >=85%',
                'Purity: >=98%',
                'Moisture Content: <=8%',
                'Viability: High',
                'Brand: Namdhari Seeds, VNR Seeds'
              ]),
              ...
              SubheadingTile(title: 'Weed and Pest Management', content: [
                'Weed and Pest Management: Metribuzin, Pendimethalin, Metsulfuron-methyl, Fluroxypyr, Neem oil, Tebuconazole'
              ]),
              SubheadingTile(title: 'Shelf Life', content: [
                'Shelf-life: 6 months'
              ]),
              SubheadingTile(title: 'Production', content: [
                '2022-2023: 12 Million Tonnes',
                ])
            ],
          ),
        ),
